  ...
  return (
    <>
      <div className="min-h-full text-sm text-zinc-800">
        <section className="absolute left-0 right-0 top-0 z-10">
          <div className="grid auto-cols-fr grid-cols-2 grid-rows-[auto] border-b-2 border-solid border-b-white/[0.15]">
            <div className="flex items-center justify-between border-r-2 border-solid border-r-white/[0.15] p-4">
              ...
              >
                <Image
                  className="inline-block h-6 w-auto max-w-full cursor-pointer align-middle"
        ...
        <section>
          <div className="relative z-[3] flex h-[100svh] flex-col justify-between px-4 pb-4 pt-16">
            ...
            <div className="grid w-full auto-cols-fr grid-cols-12 grid-rows-[auto] content-start gap-4">
              ...
              <div className="col-span-3 col-start-4 row-start-1 row-end-2 text-white">
                Brewww Studio has the talent, tools, and deliverables to
                strengthen your brand in the now and be ready for what's next.
              </div>
              <div
        ...
        <section
          className="flex flex-col gap-24 bg-white py-24 text-sm text-black"
          id="about"
        >
          ...
          <div className="container mx-auto grid grid-cols-12 gap-4">
            <p className="col-span-5 col-start-7 text-base font-normal">
              ...
              reach their goals. Our team of marketing experts will collaborate
              with you to develop tailored strategies that effectively
              communicate your unique value proposition, engage your audience,
        ...
        <div>
          <div
            className="bg-white px-4 py-4 pb-48 text-sm text-zinc-800"
            id="services"
          >
