    ...
    <>
      ...
      <section className="bg-white px-8 py-20 text-stone-950">
        <div className="max-w-8xl container mx-auto">
          <Text size="body-large" className="mb-16">
            <span className="mr-4 pb-4 text-base">Our Speciality</span>A Cleveland branding studio
            with a passion for thumb stopping visuals, compelling storytelling, and web that works
            for you.
          </Text>
        </div>
        <div className="max-w-8xl container mx-auto grid grid-cols-3 gap-8">
          <div>
            ...
            <p className="py-3 text-base">
              We distill your companys essence into a compelling visual and narrative identity. Our
              branding process goes beyond logos and color palettes—we create a kinetic brand
              experience that resonates with your audience and propels your business forward.
            </p>
            <LinkMain text="Learn More" link="/services/branding" size="medium" />
          </div>
          <div>
            ...
            <p className="py-3 text-base">
              In the digital realm, we craft immersive online experiences that captivate and
              convert. Our websites are more than just pretty interfaces; theyre strategic tools
              designed to engage your audience and drive meaningful action.
            </p>
            <LinkMain text="Learn More" link="/services/websites" size="medium" />
          </div>
          <div>
            ...
            <p className="py-3 text-base">
              We breathe life into your brand through powerful storytelling and captivating visuals.
              From illustrations to photography, we create content that not only speaks to your
              audience but moves them to action.
            </p>
            <LinkMain text="Learn More" link="/services/content" size="medium" />
          </div>
        </div>
      </section>
      <section className="bg-white text-stone-950">
        <div className="mx-auto w-full max-w-6xl px-8 py-24">
          <h2 className="mb-12 text-4xl font-bold uppercase">IMPACT & RESULTS</h2>
          <div className="grid grid-cols-3 gap-8">
            <div className="">
              ...
              <p className="mb-12 text-lg">
                ...
                of their original audio entertainment podcast.
              </p>
            </div>
            <div className="">
              <div className="mb-6 flex items-start text-6xl">
              ...
              <p className="mb-12 text-lg">
                ...
                ten times their original site investment.
              </p>
            </div>
            <div className="">
              <div className="mb-6 flex items-start text-6xl">
