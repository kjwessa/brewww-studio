      ...
      <article className="grid grid-cols-[103.906px_103.906px_103.906px_103.906px_103.906px_103.906px_103.906px_103.922px_103.906px_103.906px_103.906px_103.906px] grid-rows-[192px_auto_auto_auto_auto_76px] gap-x-10 gap-y-6">
        ...
        >
          <p>
            ...
            boundaries. Build things that last. Every strategy we develop, every pixel we place, and
            every line of code we write is crafted with tomorrow in mind.
          </p>
        </div>
        <div
        ...
        >
          <p>
            ...
            forward. <span className="text-brand-gold">We want to do top work.</span> Got something
            big you want to build? Or maybe you need help shaping that vision? Either way, we're all
            in. (let's talk)
            <a className="inline-block underline" href="">
              stands behind.
              <span className="cursor-pointer text-sm text-stone-500 uppercase">
        ...
        >
          <p>
            ...
            Got something big you want to build? Or maybe you need help shaping that vision? Either
            way, we're all in.
          </p>
        </div>
        <div
