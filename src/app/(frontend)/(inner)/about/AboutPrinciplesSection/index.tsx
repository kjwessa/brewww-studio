          ...
          <div className="grid h-min w-full auto-rows-min grid-cols-[repeat(3,minmax(1px,1fr))] grid-rows-[repeat(9,min-content)] justify-start gap-8">
            <div className="h-auto self-start justify-self-start">
              <div className="flex h-auto flex-col content-start items-start justify-start gap-4 py-6">
                ...
                >
                  <p>
                    We aim to design excellent digital products and experiences for you, in order to
                    let your business succeed. We don't play it safe.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="h-auto self-start justify-self-start">
              <div className="flex h-auto flex-col content-start items-start justify-start gap-4 py-6">
                ...
                >
                  <p>
                    We aim to work asynchronously whenever possible and appropriate. Our goal is to
                    document & communicate our work and process while respecting your time.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex h-auto flex-col content-start items-start justify-start gap-4 py-6">
                ...
                >
                  <p>
                    ...
                    help you make smarter and more effective decisions.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="h-auto self-start justify-self-start">
              <div className="flex h-auto flex-col content-start items-start justify-start gap-4 py-6">
                ...
                >
                  <p>
                    Come up with creative solutions to complex problems. Use your sense of humor in
                    a subtle and entertaining way to make things memorable and engaging.
                  </p>
                </div>
              </div>
            </div>
