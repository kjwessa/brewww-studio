        ...
        <div className="w-full text-neutral-900">
          <div className="m-auto flex min-h-screen w-full flex-col overflow-clip">
            <section className="relative bg-white min-[1000px]:pt-20 min-[1001px]:pt-28">
              <div className="m-auto w-[92%] min-[1600px]:pt-20 min-[1600px]:pb-10 min-[1920px]:pt-28 min-[1920px]:pb-12 min-[1921px]:pt-28 min-[1921px]:pb-12">
                <div>
                  <h1 className="text-[10.00rem] leading-none uppercase">Our work</h1>
                  ...
                  <div className="relative min-[1600px]:mt-16 min-[1920px]:mt-24 min-[1921px]:mt-24">
                    <ul className="list-none flex-wrap gap-[0.13rem] text-lg uppercase min-[671px]:flex min-[1600px]:mt-10 min-[1920px]:mt-12 min-[1921px]:mt-12">
                      <li className="list-item text-white">
                        <a
                          className="rounded-full bg-gray-200 min-[671px]:pt-1 min-[671px]:pr-3.5 min-[671px]:pb-1 min-[671px]:pl-3.5"
                          href=""
                        >
                      ...
                      <li className="list-item">
                        ...
                        >
                          <span className="cursor-pointer">
                            Websites
                            <sup className="inline-block align-super text-[0.63rem]">18</sup>
                          </span>
                        </a>
                      </li>
                      ...
                      <li className="list-item">
                        ...
                        >
                          <span className="cursor-pointer">
                            Shops
                            <sup className="inline-block align-super text-[0.63rem]">15</sup>
                          </span>
                        </a>
                      </li>
                      ...
                      <li className="list-item">
                        ...
                        >
                          <span className="cursor-pointer">
                            Web Apps
                            <sup className="inline-block align-super text-[0.63rem]">6</sup>
                          </span>
                        </a>
                      </li>
                    </ul>

                    <span className="absolute top-0 left-0 rounded-full bg-neutral-900" />
                  </div>
                </div>
              </div>
            </section>
              ...
              <div className="relative mb-[-100vh]">
                <div className="bg-red-400 min-[769px]:sticky min-[769px]:top-0 min-[769px]:overflow-x-hidden min-[769px]:overflow-y-hidden">
                  <div className="m-auto flex w-[92%] min-[769px]:h-screen min-[1921px]:max-w-[118.75rem]">
                    <div className="min-[769px]:relative min-[769px]:w-[34.5263%] min-[769px]:pr-14 min-[1600px]:pt-16 min-[1600px]:pb-16 min-[1920px]:pt-24 min-[1920px]:pb-24 min-[1921px]:pt-24 min-[1921px]:pb-24 md:pt-24 md:pb-24">
                      <h3 className="text-[5.00rem] leading-none uppercase">
                        <a className="inline-block" href="">
                          Classic Driven
                        </a>
                      </h3>

                      <div className="text-[1.38rem] leading-7 min-[769px]:max-w-[26.25rem] min-[1025px]:mt-5 lg:mt-5">
                        <p>
                          A website showcasing timeless craftsmanship while serving as an effective
                          marketing tool to guide Classic Driven through their next chapter.
                        </p>
                      </div>
                    ...
                    <div className="min-[769px]:w-[65.4737%]">
                      ...
                      >
                        <Image
                          className="h-auto max-w-full cursor-pointer object-cover min-[769px]:absolute min-[769px]:top-0 min-[769px]:left-0 min-[769px]:h-full min-[769px]:w-[calc(23.6334%_+_50vw)] min-[769px]:max-w-none"
                ...
                <div className="bg-stone-300 min-[769px]:sticky min-[769px]:top-0 min-[769px]:overflow-x-hidden min-[769px]:overflow-y-hidden">
                  <div className="m-auto flex w-[92%] min-[769px]:h-screen min-[1921px]:max-w-[118.75rem]">
                    <div className="min-[769px]:relative min-[769px]:w-[34.5263%] min-[769px]:pr-14 min-[1600px]:pt-16 min-[1600px]:pb-16 min-[1920px]:pt-24 min-[1920px]:pb-24 min-[1921px]:pt-24 min-[1921px]:pb-24 md:pt-16 md:pb-16">
                      <h3 className="text-[5.00rem] leading-none uppercase">
                        <a className="inline-block" href="">
                          Rome Tile
                        </a>
                      ...
                      <div className="text-[1.38rem] leading-7 min-[769px]:max-w-[26.25rem] min-[1025px]:mt-5 lg:mt-5">
                        <p>
                          A WooCommerce store where design, functionality, and narrative converge to
                ...
                <div className="bg-amber-300 min-[769px]:sticky min-[769px]:top-0 min-[769px]:overflow-x-hidden min-[769px]:overflow-y-hidden">
                  <div className="m-auto flex w-[92%] min-[769px]:h-screen min-[1921px]:max-w-[118.75rem]">
                    <div className="min-[769px]:relative min-[769px]:w-[34.5263%] min-[769px]:pr-14 min-[1600px]:pt-16 min-[1600px]:pb-16 min-[1920px]:pt-24 min-[1920px]:pb-24 min-[1921px]:pt-24 min-[1921px]:pb-24 md:pt-24 md:pb-24">
                      ...
                      <div className="text-[1.38rem] leading-7 min-[769px]:max-w-[26.25rem] min-[1025px]:mt-5 lg:mt-5">
                        <p>
                          With a fresh website on the horizon, it was the ideal moment for The
                          Fabric Emporium to reimagine their logo and visual identity.
                        </p>
                      </div>
            ...
            <section className="relative overflow-hidden bg-white min-[1600px]:pt-20 min-[1600px]:pb-20 min-[1920px]:pt-28 min-[1920px]:pb-28 min-[1921px]:pt-28 min-[1921px]:pb-28">
              <div className="m-auto w-[92%] uppercase min-[769px]:flex min-[1600px]:mb-16 min-[1920px]:mb-24 min-[1921px]:mb-24 min-[1921px]:max-w-[118.75rem]">
                ...
                <div className="text-[1.38rem] leading-7 min-[769px]:ml-auto min-[769px]:w-[65.4737%] md:mt-8">
                  <p>
                  ...
                  <ul className="grid list-none grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                    {projectsOld.docs.map((project, index) => {
                      ...
                      return (
                        ...
                        >
                          <span className="absolute top-0 left-0 z-2 w-full p-4 text-lg text-white uppercase md:p-6 lg:p-8">
                          ...
                          <div className="mt-4 flex flex-col justify-between min-[1025px]:mt-5">
                            <div className="grow">
                              ...
                              <p className="mb-4 opacity-50">{project.tagline}</p>
                            </div>
                            <div className="text-lg uppercase">
                              ...
                              >
                                <span className="relative cursor-pointer">
                                  View
                                  <span className="absolute top-full left-0 w-full rounded-tl-full rounded-tr-full bg-white" />
                                </span>
                              </Link>
                            </div>
                          </div>
