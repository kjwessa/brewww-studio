...
export function BeforeAfter({
  ...
  return (
    <section
      className={`${backgroundColor} px-2 text-black sm:px-6 xl:px-12 min-[1450px]:px-20 min-[1800px]:px-40 min-[2100px]:px-60`}
    >
      <div className="flex w-full flex-wrap">
        <div className="w-full px-2 lg:px-3 xl:px-4">
          ...
          >
            ...
            >
              <div className="absolute left-1/2 top-1/2 flex h-8 w-8 -translate-x-1/2 -translate-y-1/2 transform items-center justify-center rounded-full bg-white">
                <svg
                  className="h-4 w-4"
                  viewBox="0 0 24 24"
                  fill="none"
