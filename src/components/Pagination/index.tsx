            ...
            <div key={index}>
              <button
                ...
                className={`relative mr-2 flex h-16 w-16 items-center justify-center border sm:mr-1 sm:h-8 sm:w-8 ${
                  isCurrent
                    ? 'before:opacity-8 pointer-events-none border-current before:absolute before:left-[1px] before:top-[1px] before:box-border before:h-[calc(100%-2px)] before:w-[calc(100%-2px)] before:bg-[url("/images/scanline-dark.png")] before:bg-repeat before:content-[""] dark:before:bg-[url("/images/scanline-light.png")] dark:before:opacity-10'
