...
const clampVariants = cva('block overflow-hidden', {
  variants: {
    lines: {
...
interface ClampProps
  extends React.HTMLAttributes<HTMLDivElement>,
    Omit<VariantProps<typeof clampVariants>, 'gradient'> {
  as?: ElementType
  gradient?: boolean
...
export const Clamp = ({
  ...
  return (
    <>
      <Component
        className={cn(clampVariants({ lines, gradient: showGradient }), className)}
        {...props}
      >
        {children}
      </Component>
