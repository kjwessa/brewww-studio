...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_testimonial_order_idx" ON "pages_blocks_testimonial" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_testimonial_parent_id_idx" ON "pages_blocks_testimonial" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_testimonial_path_idx" ON "pages_blocks_testimonial" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "pages_blocks_testimonial_testimonial_idx" ON "pages_blocks_testimonial" USING btree ("testimonial_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_testimonial_order_idx" ON "_pages_v_blocks_testimonial" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_testimonial_parent_id_idx" ON "_pages_v_blocks_testimonial" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_testimonial_path_idx" ON "_pages_v_blocks_testimonial" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_testimonial_testimonial_idx" ON "_pages_v_blocks_testimonial" USING btree ("testimonial_id");`)
}
